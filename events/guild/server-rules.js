...
const { rulesChannelId, rulesServerId } = require('../../config.json');
...
module.exports = {
    ...
    async execute(client) {
        try {
            const guild = client.guilds.cache.get(rulesServerId);
            if (!guild) return console.warn('Rules server not found');
